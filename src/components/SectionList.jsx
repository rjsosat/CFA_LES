...
import { CFA_L2_EXAM_WEIGHTS } from '../data/examWeights';
...
function SectionItem({ section, completionState, onToggleSubsection }) {
  ...
  const examWeight = CFA_L2_EXAM_WEIGHTS[section.id];
      ...
      >
        <div className="flex-1 text-left pr-4">
          <div className="flex items-center justify-between mb-1">
            ...
            {examWeight && (
              <span className="text-[10px] font-bold text-indigo-600 bg-indigo-50 border border-indigo-200 px-2 py-0.5 rounded-md">
                Exam: {examWeight.weight}
              </span>
            )}
          </div>
